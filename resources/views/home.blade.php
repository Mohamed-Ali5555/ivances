    ...
    <div class="row row-sm">
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-primary-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">الاجمالي </h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-danger-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white">الفواتير الغير
                                    مدفوعة  </h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
...
{{-- ///////////////////////////////////////////////////////////////////////////////////////////// --}}
                ...
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    ...
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">
                                    {{ number_format(\App\invoices::where('value_status', 1)->sum('total')) }}</h4>
                                <p class="mb-0 tx-12 text-white op-7">
        ...
        <div class="col-xl-3 col-lg-6 col-md-6 col-xm-12">
            <div class="card overflow-hidden sales-card bg-warning-gradient">
                <div class="pl-3 pt-3 pr-3 pb-2 pt-0">
                    <div class="">
                        <h6 class="mb-3 tx-12 text-white"> الفواتير المدفوعة
                                    جزئيا </h6>
                    </div>
                    <div class="pb-0 mt-0">
                        <div class="d-flex">
                            <div class="">
                                <h4 class="tx-20 font-weight-bold mb-1 text-white">{{ number_format(\App\invoices::where('value_status', 3)->sum('total')) }}</h4>
    ...
    <div class="row row-sm">
        <div class="col-md-12 col-lg-12 col-xl-7">
            <div class="card">
                ...
                <div class="card-body" style="width:75%;height:378px;">
                 {!! $chartjs->render() !!}
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-12 col-xl-5">
            <div class="card card-dashboard-map-one">
                ...
                <div class="" style="width: 100%;height:378px;">
                    {!! $chartjs_2->render() !!}
                </div>
            </div>
        </div>
